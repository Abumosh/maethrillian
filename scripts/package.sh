...
PKG_DATA_EXTENSIONS='\.xml$|\.cfg$|\.ddx$|\.tactics$|\.ai$|\.vis$|\.triggerscript$|\.triggerscript_runtime$|\.scpt_runtime$|\.scpt_list$|\.scol_list$|\.scol$|\.scn$|\.mission_settings$|\.global_lights$'
